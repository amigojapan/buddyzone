...
*/
        ...
        doc.open("GET", "http://amigojapan.duckdns.org/LocationServer/LocationServerQuads.php?operation=FetchMessages&LastServerTime="+lastServerTime+"&lat=100&longi=100&TOclientID=usertest",false);//appWindow.uid2
        doc.send();
    }
    btnBoradcast{
       onClicked: {
